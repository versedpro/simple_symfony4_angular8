 ...
 */
final class Version20190910133149 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE continent (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contry (id INT AUTO_INCREMENT NOT NULL, continent_id INT NOT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_9811AE9B921F4C77 (continent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE city ADD CONSTRAINT FK_2D5B0234CD33232C FOREIGN KEY (contry_id) REFERENCES contry (id)');
        $this->addSql('ALTER TABLE contry ADD CONSTRAINT FK_9811AE9B921F4C77 FOREIGN KEY (continent_id) REFERENCES continent (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contry DROP FOREIGN KEY FK_9811AE9B921F4C77');
